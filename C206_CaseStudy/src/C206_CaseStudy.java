...
public class C206_CaseStudy {
	...
	public static void viewAllJobProfiles() {
		...
		JobProfile jobProfile1 = new JobProfile("Criminal Lawyer", "Lee & Brothers",
				"Represents defendants and organizations with criminal charges.", 80000.0);
	...
	public static void deleteJobProfile() {
		...
		jobProfiles.add(new JobProfile("Criminal Lawyer", "Lee & Brothers",
				"Represents defendants and organizations with criminal charges.", 80000.0));
